...
public class ClientGui {
	...
	private void initialize(Connection c, MessageList messages, ClientController control) {
		frame = new JFrame();
		frame.setTitle("[" + c.group + "] Node " + c.node + " @ HumanNetwork");
		...
		frame.getContentPane().add(btnAddCheck);
		...
		frame.getContentPane().add(btnNonce);
		...
		frame.getContentPane().add(btnVerifyChecksum);
		...
		frame.getContentPane().add(lblNode_1);
