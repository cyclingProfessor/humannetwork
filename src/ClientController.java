...
public class ClientController {
	...
	public void bind(final JTextField txtMessage, final JList<Message> list,
			JButton btnAdd, JButton btnSend, JButton btnNonce, JButton btnSplit,
			JButton btnMerge, JButton btnAddCheck, JButton btnDelete,
			JButton btnVerifyChecksum, JButton btnMoveUp, JButton btnMoveDown,
			JButton btnEncrypt, JButton btnDecrypt) {
		...
		btnSend.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String to = (String) JOptionPane
						.showInputDialog("Node number of the recipient (0 for broadcast)");
				try {
		...
		btnVerifyChecksum.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (message.length() > 3) {
					...
					try {
						int checksum = Integer.parseInt(message.substring(
